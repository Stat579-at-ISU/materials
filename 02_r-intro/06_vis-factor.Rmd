...
For this your turn use the `titanic` object from the `classdata` package. (you might have to update the package using the command `devtools::install_github("heike/classdata")`) 
