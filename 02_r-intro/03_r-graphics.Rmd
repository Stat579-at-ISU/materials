...
```{r setup, echo=FALSE}
library(knitr)
opts_chunk$set(warning=FALSE, out.height=350)
```
...
```{r, echo=FALSE, warning=FALSE, out.height=500, fig.width = 8, fig.height = 5}
...
```{r fig.height=4, fig.width=8, out.height = 300}
