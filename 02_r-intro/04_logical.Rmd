...
slice_max(fbiwide, burglary, prop = 0.1) # highest 10 percent
```
...
Use the `fbi` data object to answer the following questions. The following question can be answered with a combination of `filter` and `slice`

- Get a subset of the data that includes number of homicides for the last five years. Find the rate of homicides, extract all states that have a rate of greater than 90% of the rates across all states, and plot.
